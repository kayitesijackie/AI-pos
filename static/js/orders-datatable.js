    ...
    let html = `<table class="table table-sm table-hover table-active">
                  <thead>
                    <tr>
                      ...
                      <th scope="col" class="font-weight-bolder">Cost (RWF)</th>
                      <th scope="col" class="font-weight-bolder">MRP (RWF)</th>
                      <th scope="col" class="font-weight-bolder">Final Price (RWF)</th>
                      <th scope="col" class="font-weight-bolder">Profit (RWF)</th>
                    </tr>
                  </thead>
                <tbody>`;
